...
let handler = async (m, { isPrems, conn }) => {
  ...
  let money =
    `${pickRandom([300, 500, 700, 900, 500, 800, 900, 1100, 1350, 1500])}` * 1;
  let moneypremium =
    `${pickRandom([
      800, 1300, 1600, 1900, 2200, 2500, 2700, 3000, 3300, 3500,
    ])}` * 1;
  ...
  let umpanpremium =
    `${pickRandom([30, 60, 90, 120, 150, 180, 210, 240, 270, 300])}` * 1;
